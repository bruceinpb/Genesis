...
const GENRE_DATA = [
  ...
  {
    id: 'documentary-historical-prose',
    label: 'Documentary Historical Prose',
    rules: 'Write in an archival documentary voice built almost entirely from verified historical record. Authorial speculation must be minimized or eliminated. Emotional and interpretive tone comes from fact arrangement and evidence selection, not from commentary or editorializing. The writer is nearly invisible — let the documented record speak. Present events chronologically or thematically with minimal interpretive language. Quotations from primary sources carry narrative emotion instead of author prose. Dialogue must be sourced or reconstructed from documented material — never invented. Tone should resemble curated evidence. Use third-person omniscient but restrained perspective. Avoid psychological guessing unless supported by letters, interviews, or contemporaneous accounts. Avoid dramatization unless documented. Avoid metaphor and literary flourish. Prose often reads as: "X occurred. Evidence indicates Y. Contemporary accounts state Z." Heavy reliance on primary sources — letters, diaries, official records, interviews, newspaper accounts. Footnote or source transparency is expected. Credibility, scholarly trust, historical defensibility, and longevity of interpretation are paramount.',
    subgenres: [
      { id: 'dochist-archival-biography', label: 'Archival Documentary Biography', rules: 'Biography built from exhaustive archival research. The subject\'s life reconstructed from letters, diaries, government records, court transcripts, and contemporaneous accounts. Minimal author intrusion. Quotations used as emotional and narrative weight. Every claim evidence-anchored. The biographer\'s voice is invisible; the subject and their documented world carry the story. Chernow-style scholarly rigor with accessible prose.' },
      { id: 'dochist-narrative-documentary', label: 'Literary Documentary Biography', rules: 'Blends documentary foundation with literary narrative overlay. Exhaustive archival research and factual reconstruction combined with scene construction, character interiority (only when supported by documented evidence), and thematic arcs such as power, influence, and systems. Robert Caro tradition — the apex of fact-based storytelling. Dramatic structure and pacing regained without breaking evidentiary discipline. Every scene grounded in documented material but shaped with narrative craft.' },
      { id: 'dochist-objective-historical', label: 'Objective Historical Voice', rules: 'Strict objective historical reporting. Third-person omniscient but maximally restrained. Avoids psychological guessing entirely. Avoids dramatization unless documented in primary sources. Avoids all metaphor and literary flourish. Events listed in evidence-supported order with minimal narrative shaping. Reads like curated evidence presented with scholarly precision. Suitable for academic biographies and serious historical scholarship where credibility and defensibility are prioritized above all.' },
      { id: 'dochist-narrative-history', label: 'Evidence-Driven Narrative History', rules: 'Historical events told through evidence-driven narrative. The sweep of history rendered through documented individual experiences, archival records, and primary sources. McCullough/Ambrose tradition filtered through strict documentary discipline. Immersive historical storytelling where every detail is sourced. Scene-setting and atmosphere drawn from contemporaneous accounts rather than authorial imagination. The narrative serves the evidence, not the reverse.' },
      { id: 'dochist-microhistorical', label: 'Microhistorical Documentary', rules: 'Deep archival reconstruction of small slices of history. A single event, community, trial, or episode examined in granular documentary detail. Primary sources — court records, parish registers, personal correspondence, newspaper archives — assembled into intimate, evidence-dense narrative. The narrow focus reveals broader historical patterns. Every fact traceable to a specific source. Scholarly rigor applied at microscopic scale.' }
    ]
  },
  {
    id: 'poetry',
